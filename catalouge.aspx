...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:DataList ID="dlCategory" runat="server" RepeatDirection="Horizontal" style="width:1500px; letter-spacing:2px;justify-content:space-evenly; margin-top:2%; text-decoration:underline">
        <ItemTemplate>
            <asp:HyperLink ID="hlCategory" runat="server" NavigateUrl='<%# "?CategoryID="+Eval("CategoryID") %>' Text='<%# Eval("CategoryShortDesc") %>' style="color:blue; padding:5%; justify-content:space-evenly"></asp:HyperLink>
        </ItemTemplate>
    </asp:DataList>

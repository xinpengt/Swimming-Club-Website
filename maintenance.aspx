...
<asp:Content ID="Main" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:MultiView ID="mvMaintenance" runat="server" EnableViewState="false">
        <asp:View ID="vMainUsers" runat="server">
            <asp:DropDownList ID="ddlSortBy" runat="server" OnSelectedIndexChanged="ddlSortBy_SelectedIndexChanged"  AutoPostBack="true">
            ...
            <br />
            <asp:TextBox ID="txtSearchUsers" runat="server" Visible="false" Height="20px"></asp:TextBox>
        ...
        <asp:View ID="vMainEcat" runat="server">
            <asp:DropDownList ID="ddlMaintainECat" runat="server" OnSelectedIndexChanged="ddlMaintainECat_SelectedIndexChanged" AutoPostBack="true">
                <asp:ListItem>Choose 1</asp:ListItem>
            ...
            <div id="divMaintainCat" runat="server" visible="false">
                ...
                <asp:GridView ID="gvCategories" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnRowCancelingEdit="gvCategories_RowCancelingEdit" OnRowEditing="gvCategories_RowEditing" OnRowUpdating="gvCategories_RowUpdating" OnRowDeleting="gvCategories_RowDeleting" OnPageIndexChanging="gvCategories_PageIndexChanging" PageSize="5" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btnEditCat" runat="server" Text="Edit" CommandName="Edit" CausesValidation="False" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Button ID="btnUpdateCat" runat="server" Text="Update" CommandName="Update" ValidationGroup="UpdatingCategory"/>
                                <asp:Button ID="btnCancelUpdateCat" runat="server" Text="Cancel" CommandName="Cancel" CausesValidation="False"  />
                                <asp:Button ID="btnDeleteCat" runat="server" Text =" Delete" CommandName="Delete" CausesValidation="False" />
                            </EditItemTemplate>
                ...
                <div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNewCatID" runat="server" TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNewCatShortDesc" runat="server" TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNewCatLongDesc" runat="server" TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td>
            ...
            <div id="divMaintainProd" runat="server" visible="false">
                ...
                <asp:DropDownList ID="ddlCategoryList" runat="server" DataTextField="CategoryShortDesc" DataValueField="CategoryID" DataSourceID="SqlDataSourceCatList" Height="20px"></asp:DropDownList>
                ...
                <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False" OnRowEditing="gvProducts_RowEditing" OnRowCancelingEdit="gvProducts_RowCancelingEdit" OnRowUpdating="gvProducts_RowUpdating" OnRowDeleting="gvProducts_RowDeleting" OnPageIndexChanging="gvProducts_PageIndexChanging" AllowPaging="True" 
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btnProdEdit" runat="server" CommandName="Edit" Text="Edit" CausesValidation="False" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Button ID="btnUpdateProd" runat="server" Text="Update" CommandName="Update" ValidationGroup="Update Product" />
                                <asp:Button ID="btnCancelUpdateProd" runat="server" Text="Cancel" CommandName="Cancel" CausesValidation="False" />
                                <asp:Button ID="btnDeleteProd" runat="server" Text =" Delete" CommandName="Delete" CausesValidation="False" />
                            </EditItemTemplate>
                            <ControlStyle BackColor="White" ForeColor="Black" Width="60px" />
                        </asp:TemplateField>
                ...
                <div>
                    ...
                    <table>
                        <tr>
                            <td>Product ID</td>
                            <td>
                                <asp:TextBox ID="txtNewProdID" runat="server"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Name</td>
                            <td>
                                <asp:TextBox ID="txtNewProdName" runat="server" TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Description</td>
                            <td>
                                <asp:TextBox ID="txtNewProdDesc" runat="server" TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Price</td>
                            <td>
                                <asp:TextBox ID="txtNewProdPrice" runat="server"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Quantity</td>
                            <td>
                                <asp:TextBox ID="txtNewProdQuantity" runat="server" TextMode="Number"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Category</td>
                            <td>
                                <asp:DropDownList ID="ddlNewProdCat" runat="server" DataTextField="CategoryShortDesc" DataValueField="CategoryID" DataSourceID="SqlDataSourceCatList">
                                </asp:DropDownList>
                            </td>
                            <td>
        ...
        <asp:View ID="vMainNews" runat="server">
            ...
            <asp:GridView ID="gvNews" runat="server" EmptyDataText="There is no news" AllowPaging="True" AutoGenerateColumns="False" OnRowCancelingEdit="gvNews_RowCancelingEdit" OnRowEditing="gvNews_RowEditing" OnRowUpdating="gvNews_RowUpdating" OnRowDeleting="gvNews_RowDeleting" OnPageIndexChanging="gvNews_PageIndexChanging" PageSize="5"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnEditNews" runat="server" Text="Edit" CommandName="Edit" CausesValidation="false"/>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Button ID="btnUpdateNews" runat="server" Text="Update" CommandName="Update" ValidationGroup="Update News" />
                            <asp:Button ID="btnDeleteNews" runat="server" Text="Delete" CommandName="Delete" CausesValidation="false"/>
                            <asp:Button ID="btnCancelNewsUpdate" runat="server" Text="Cancel" CommandName="Cancel" CausesValidation="false"/>
                        </EditItemTemplate>
                        <ControlStyle BackColor="White" ForeColor="Black" Width="60px" />
                    </asp:TemplateField>
        ...
        <asp:View ID="vMainFaq" runat="server">
            ...
            <asp:GridView ID="gvFaq" runat="server" EmptyDataText="There is no FAQ" AllowPaging="True" AutoGenerateColumns="False" OnRowCancelingEdit="gvFaq_RowCancelingEdit" OnRowEditing="gvFaq_RowEditing" OnRowUpdating="gvFaq_RowUpdating" OnRowDeleting="gvFaq_RowDeleting" OnPageIndexChanging="gvFaq_PageIndexChanging" PageSize="5"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnEditFaq" runat="server" Text="Edit" CommandName="Edit" CausesValidation="false" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:Button ID="btnUpdateFaq" runat="server" Text="Update" CommandName="Update" ValidationGroup="Update FAQ"/>
                            <asp:Button ID="btnCancelFaq" runat="server" Text="Cancel" CommandName="Cancel" CausesValidation="false" />
                            <asp:Button ID="btnDeleteFaq" runat="server" Text="Delete" CommandName="Delete" CausesValidation="false" />
                        </EditItemTemplate>
                        <ControlStyle BackColor="White" ForeColor="Black" Width="60px" />
                    </asp:TemplateField>
            ...
            <table>
                <tr>
                    <td>FAQ Question</td>
                    <td>
                        <asp:TextBox ID="txtNewFaqQuestion" runat="server" TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td>FAQ Answer</td>
                    <td>
                        <asp:TextBox ID="txtNewFaqAnswer" runat="server"  TextMode="MultiLine" Wrap="true" Rows="5" CssClass="textbox"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFaqSearchTerm" runat="server"></asp:TextBox>
                    </td>
                    <td>
